...
/*
 *  * Struct node that stores the value of the node, a previous and next pointer to
 *   * the other pointers in the list, as well as a reference count of how many 
 *    * pointers point to that particular node. 
 *     */
...
/* 
 *  * Creates a node given the data that is to be stored in the node
 *   */
...
/* 
 *  * Increments or decrements refCount of a node, internal function. (takes 1 or -1)
 *   */
 ...
 *         * to some mobject in the list as the next one to be returned but that
